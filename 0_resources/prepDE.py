...
# This script will generate a count matrix of transcripts from stringtie --merge.
# This script was copied from https://ccb.jhu.edu/software/stringtie/index.shtml?t=manual
