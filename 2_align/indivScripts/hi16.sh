...
#SBATCH --output=hi16.out
#SBTACH --error=hi16.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/16/16_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/16/16_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/16.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/16
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/16.txt
