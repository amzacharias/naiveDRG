...
#SBATCH --output=hi7.out
#SBTACH --error=hi7.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/7/7_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/7/7_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/7.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/7
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/7.txt
