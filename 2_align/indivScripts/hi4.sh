...
#SBATCH --output=hi4.out
#SBTACH --error=hi4.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/4/4_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/4/4_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/4.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/4
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/4.txt
