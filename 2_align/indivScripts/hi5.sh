...
#SBATCH --output=hi5.out
#SBTACH --error=hi5.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/5/5_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/5/5_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/5.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/5
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/5.txt
