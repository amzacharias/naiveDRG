...
#SBATCH --output=hi11.out
#SBTACH --error=hi11.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/11/11_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/11/11_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/11.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/11
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/11.txt
