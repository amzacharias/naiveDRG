...
#SBATCH --output=hi18.out
#SBTACH --error=hi18.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/18/18_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/18/18_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/18.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/18
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/18.txt
