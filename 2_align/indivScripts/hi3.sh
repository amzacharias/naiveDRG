...
#SBATCH --output=hi3.out
#SBTACH --error=hi3.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/3/3_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/3/3_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/3.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/3
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/3.txt
