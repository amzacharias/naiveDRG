...
#SBATCH --output=hi6.out
#SBTACH --error=hi6.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/6/6_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/6/6_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/6.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/6
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/6.txt
