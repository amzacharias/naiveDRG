...
# Set variables
INPUT=absolutePath/mouNaiveSNI/2_align/aligned/7.sort.mrkdup.bam
OUT_GTF=absolutePath/mouNaiveSNI/3_naiveDrg/1_stringtie/pass2gtfs/7.gtf
REF_GTF=absolutePath/mouNaiveSNI/3_naiveDrg/1_stringtie/3_merge/d.merged.gtf
BALL=absolutePath/mouNaiveSNI/3_naiveDrg/1_stringtie/ballgown/d/7
