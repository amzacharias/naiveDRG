...
#SBATCH --output=hi12.out
#SBTACH --error=hi12.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/12/12_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/12/12_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/12.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/12
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/12.txt
