...
#SBATCH --output=hi17.out
#SBTACH --error=hi17.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/17/17_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/17/17_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/17.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/17
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/17.txt
