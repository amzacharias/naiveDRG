...
#SBATCH --output=hi13.out
#SBTACH --error=hi13.err
...
# Set variables
PAIRED_END_1=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/13/13_1.fq.gz
PAIRED_END_2=absolutePath/mouNaiveSNI/0_data/F20FTSUSA1339_MOUpfnaT/CleanData/13/13_2.fq.gz
INDEX=absolutePath/mouNaiveSNI/2_align/indexGencode/idx
SAM_PATH=absolutePath/mouNaiveSNI/2_align/aligned/13.sam
OUT_PATH=absolutePath/mouNaiveSNI/2_align/aligned/13
SUMMARY_PATH=absolutePath/mouNaiveSNI/2_align/summaries/13.txt
